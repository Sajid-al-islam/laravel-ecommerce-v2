<template>
    <div @mouseover="mouseover" @mouseleave="mouseleave">
        <ul class="navigation navigation-main" id="main-menu-navigation" data-menu="menu-navigation">
            ...
            <left-nav-list-group :role_permissions="['super_admin','admin']" :icon="`fa fa-box`" :text="`Variant`" :alert_count="0">
                <left-nav-list-item :to="'CreateVariant'" :text="'Create variant'" />
                <left-nav-list-item :to="'AllVariant'" :text="'Variants'" />
                <left-nav-list-item :to="'VariantValues'" :text="'Values'" />
            </left-nav-list-group>
            ...
            <li class="navigation-header">
                <span data-i18n="Apps &amp; Pages">management</span>
            </li>
            ...
            <left-nav-list-group :role_permissions="['super_admin','admin','user']" :icon="`fa fa-gears`" :text="`Settings`" :alert_count="0">
                <left-nav-list-item :to="'BasicInformation'" :text="'All Settings'" />
