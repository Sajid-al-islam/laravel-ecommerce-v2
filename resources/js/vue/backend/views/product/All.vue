                ...
                <table class="table table-hover table-bordered">
                    <thead class="table-light">
                        <tr>
                            ...
                            <table-th :tkey="'low_stock'" :title="'Low Stock'" />
                    ...
                    <tbody class="table-border-bottom-0">
                        <tr v-for="(item, index) in this[`get_${store_prefix}s`].data" :key="item.id">
                            ...
                            <td>
                                <img v-if="item.related_images.length" :src="`/${item.related_images[0].image}`" style="width: 40px;" alt="">
                            </td>
                            <td>
                                <input v-if="item.is_top_product" @change="call_store(`is_top_product_${store_prefix}`,{event:$event,id:item.id})" checked type="checkbox" class="form-check-input">
                                <input v-else type="checkbox" @change="call_store(`is_top_product_${store_prefix}`,{event:$event,id:item.id})" class="form-check-input">
                            </td>
                            <td>
                            ...
                            <td>
                                <span class="text-warning font-bold">
                                    {{ item.stocks_sum_qty - Math.abs(item.sales_sum_qty) }}
                                </span>
                            </td>
                            <td>
