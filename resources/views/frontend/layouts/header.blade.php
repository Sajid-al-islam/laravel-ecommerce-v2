        ...
        <div class="header_area_content custom-container">
            ...
            <div class="search_area">
                <form class="w-100" onsubmit="event.preventDefault();">
                    <input class="form-control" type="text" onkeyup="search_prodcut()" placeholder="Search Products" />
            ...
            <div class="item_area">
                ...
                <div class="item account">
                    <span href="#" onclick="location.href='/cart'">
                        <div class="icon">
            ...
            <div class="responsive_header_manu">
                ...
                <div class="search_and_card">
                    <a href="/login" class="card_icon">Login</a>
